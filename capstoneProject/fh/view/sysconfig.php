      ...
      <section class="content">
          <div class=" justify-content-between    ">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                  <h2 class="content-header">Disease Entry / Update</h2>
                  <form action="./script/illness_info.php" method="POST">
                    <div class="form-group">
                        <label for="illnessType">Disease Type</label>
                        <input id="illnessType" type="text" class="form-control form-control-lg"  aria-describedby="emailHelp" placeholder="Disease Type" name="illnessType">
                        <small class="form-text text-muted">New or Update Disease Information</small>
                    </div>
                    <div class="form-group">
            ...
            ` <div class="table-responsive"> 
                <h2 class="content-header">Disease Management</h2>

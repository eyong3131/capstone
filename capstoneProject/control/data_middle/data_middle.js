$(document).ready(function(){
    ...
    lengthMenu:[
        [10,25,50,400],
        ['10 rows', '25 rows', '50 rows', '400 rows']
    ],
    ...
    $('#dataTable tbody').delegate('tr td:nth-child(1)', 'click', function(){
        var dataRow = dataTable.row(this).data();
        var patient_profile_id = dataRow["id"];
        dataTable.ajax.url("../control/fetch/fetch_patient.php?patient_profile_id="+patient_profile_id);

                    ...
                    <table class="lead form-group">
                              <tr>
                                  ...
                                  <td class='input-group fullName'>
                                    ...
                                    <input id="middle" class='form-control form-control-lg'  type='text' name='P_middle' placeholder="Middle" >
                            ...
                            <tr><td><label>Illness</label></td> <td> </td> <td><input class="name form-control form-control-lg" type="text" name="P_illness" placeholder="Illness Type" list="diseaseSuggest" required></td></tr>
                            <tr><td><label>Date</label></td> <td> </td> <td><input class="name form-control form-control-lg" type="date" name="P_date" required></td></tr>
                            <tr><td><label>Optional</label><td> </td></td><td class="form-floating "><textarea class="name form-control form-control-lg " placeholder="Illness Description"  name="P_description" ></textarea></td></tr>

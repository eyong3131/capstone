    ...
    <div class="content-wrapper">
      ...
      <section class="content">
          <div class="row">
              ...
              <h2>About</h2>
              <h4 class="div_about">
The web based viral diseases monitoring system
with decision support will help the barangay belong
to the district 4 in San Pablo City  to easily
monitor the other viral diseases by using monitoring
system it helps to increase productivity and less
time spent to controlling the proper functioning of
the system mainly because monitoring system will take
care of it. Monitoring systems have some features like
graphic visualization, reports, and record. In order
to facilitate the analysis of the data provided the
monitoring tool will create a graph with the data
provided; The aimed of this monitoring system will
help in tracking viral diseases in real-time and
offer up-to-date statistics concerning the prevalence
of viral diseases which can also additionally are available
on hand to decide feasible outbreaks.
              </h4>
              </div>
              <div class="col-md-4">
                  <img src="../assets/img/viral.png" alt="Viral Image" width="100%">
              </div>
            </div>
      </section>
      <!-- /.content -->
